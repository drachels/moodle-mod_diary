...
class mod_diary_renderer extends plugin_renderer_base
{
     ...
     *
     * @param int $diary
     *            Diary activity this description is for.
     * @param int $cm
     *            Course module this description is for.
     ...
     *
     * @param int $firstkey
     *            Id of the entry for the current sort order.
    ...
    public function diary_inaccessible($message)
    {
        ...
        $output .= $message;
        $output .= $this->output->box('<a href="' . $CFG->wwwroot . '/course/view.php?id=' . $this->page->course->id . '">' . get_string('returnto', 'diary', format_string($this->page->course->fullname, true)) . '</a>', 'diarybutton standardbutton');
