...
class mod_diary_renderer extends plugin_renderer_base {
     ...
     *
     * @param bool $cm        Course module this description is for.
     * @param bool $diary     Diary actvity this description is for.
     * Return the $output     Return a box with the description in it.
     */
     ...
     *
     * @param bool $context   Context this toolbar is for.
     * @param bool $course    Course this toolbar is for.
     * @param bool $id        Cmid this toolbar is for.
     * @param bool $diary     Diary this toolbar is for.
     * @param bool $firstkey  Id of the entry for the current sort order.
