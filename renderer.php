...
class mod_diary_renderer extends plugin_renderer_base {
     ...
     *
     * @param int $context   Context this toolbar is for.
     * @param int $course    Course this toolbar is for.
     * @param int $id        Cmid this toolbar is for.
     * @param int $diary     Diary this toolbar is for.
