...
if ($prompts) {
    foreach ($prompts as $prompt) {
        ...
        $jlink1 = '&nbsp;<a onclick="return confirm(\''
                  ...
                  .$data->entryid
                  .'\')" href="prompt_edit.php?id='
                  .$id.'&action=delete&promptid='
                  .$prompt->id.'" class="diary_prompt" id="diary_'
                  .$prompt->id.'"><img src="pix/delete.png" title="'
        ...
        $jlink2 = '<a href="prompt_edit.php?id='.$id
                  .'&action=edit&promptid='.$data->entryid
...
$url2 = $CFG->wwwroot . '/mod/diary/prompt_edit.php?id='.$cm->id.'&action=create&promptid=0';
