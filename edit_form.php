...
class mod_diary_entry_form extends moodleform {
    ...
    public function definition() {
        ...
        $debug = [];
        $debug['1 In the Diary edit_form.php file'] = '++++++++++++++++++++++++++';
        ...
        if (core_tag_tag::is_enabled('mod_diary', 'diary_entries')) {
            ...
            $mform->addElement('tags', 'tags', null, ['itemtype' => 'diary_entries', 'component' => 'mod_diary']);
        }
        ...
        // 20240426 Trying to get promptid set to old one, if it exists.
