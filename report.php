...
if (!$users) {
    ...
    //$saveallbutton .=  "<input type=\"submit\" value=\"".get_string("saveallfeedback", "diary")."\" />";
...
/*
    // 20200420 Added a return button.
    $url = $CFG->wwwroot . '/mod/diary/view.php?id='.$id;
    echo '<br><a href="'.$url.'" class="btn btn-primary" role="button">'
        //.get_string('returnto', 'diary', $diary->name).'</a>'.'</form>';
...
*/
    ...
    foreach ($users as $user) {
        echo diary_print_user_entry($course, $diary, $user, NULL, $teachers, $grades);
    }
