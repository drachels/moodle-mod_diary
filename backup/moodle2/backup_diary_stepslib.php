...
class backup_diary_activity_structure_step extends backup_activity_structure_step
{
    ...
    protected function define_structure()
    {
        ...
        $diary = new backup_nested_element('diary', array(
            'id'
        ), array(
            'name',
            'intro',
        ...
        $entry = new backup_nested_element('entry', array(
            'id'
        ), array(
            'userid',
            'timecreated',
        ...
        $tag = new backup_nested_element('tag', array(
            'id'
        ), array(
            'itemid',
            'rawname'
        ...
        $rating = new backup_nested_element('rating', array(
            'id'
        ), array(
            'component',
            'ratingarea',
        ...
        // Define sources.
        $diary->set_source_table('diary', array(
            'id' => backup::VAR_ACTIVITYID
        ));

        // All the rest of elements only happen if we are including user info.
        if ($this->get_setting_value('userinfo')) {
            $entry->set_source_table('diary_entries', array(
                'diary' => backup::VAR_PARENTID
            ));
