...
class diarystats {
    ...
    public static function get_common_errors($text, $diary) {
        ...
        if ($cm) {
            ...
            if (count($entryids)) {
                [$select, $params] = $DB->get_in_or_equal($entryids);
