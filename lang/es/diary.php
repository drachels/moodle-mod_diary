...
$string['minchar'] = 'Cantidad mínima de caracteres';
...
$string['mincharacterlimit'] = 'Cantidad mínima de caracteres';
...
$string['minmaxwordpercent'] = 'Penalización de palabra por error de conteo Min/Max ';
...
$string['minparagraph'] = 'Cantidad mínima de párrafos';
...
$string['minparagraphlimit'] = 'Cantidad mínima de párrafos';
...
$string['minsentence'] = 'Cantidad mínima de oraciones';
...
$string['minsentencelimit'] = 'Cantidad mínima de oraciones';
...
$string['modulename_help'] = 'El diario de esta actividad habilita a los profesores obtener retroalimentacion de los estudiantes
 en un período de tiempo.';
$string['modulename'] = 'Diario';
$string['modulenameplural'] = 'Diarios';
$string['needsgrading'] = ' Esta entrada no ha tenido una retroalimentación o calificación aún.';
...
$string['promptid'] = 'Id de aviso';
$string['promptinfo'] = 'Hay {$a->past} mensaje(s) pasado(s), {$a->current} mensaje(s) actual(es) y {$a->future} mensaje(s) futuro(s) para esta actividad del diario.<br>';
