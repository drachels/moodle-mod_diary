...
$string['autograderulevisible'] = 'Student visibility';
$string['autograderulevisible_help'] = 'When set to Visible, this phrase and any missing-phrase feedback are shown to the student. When Hidden, the rule still affects the grade silently — the student is not told about it.';
$string['autograderulevisiblehidden'] = 'Hidden from students';
$string['autograderulevisiblevisible'] = 'Visible to students';
...
$string['avgsylperword_help'] = 'Average number of syllables per word in the entry text.';
$string['avgwordlenchar'] = 'Average word length {$a} characters';
$string['avgwordlenchar_help'] = 'Average number of characters per word in the entry text.';
$string['avgwordpara'] = 'Average words per paragraph {$a}';
$string['avgwordpara_help'] = 'Average number of words per paragraph in the entry text.';
...
$string['charspersentence_help'] = 'Average number of characters per sentence in the entry text.';
$string['clearfeedback'] = 'Clear feedback';
$string['clearmanualprompt'] = 'Clear manual override';
...
$string['completionmetricinvalidnumber'] = 'Enter a numeric required value for each selected metric requirement.';
$string['completionmetricinvalidpenalty'] = 'Enter a valid non-negative penalty for each selected metric requirement.';
$string['completionmetricoperator'] = 'Requirement operator';
$string['completionmetricoperatoratleast'] = 'At least (>=)';
$string['completionmetricoperatoratmost'] = 'At most (<=)';
$string['completionmetricpenalty'] = 'Penalty points';
$string['completionmetricrequirements'] = 'Completion metric requirements';
$string['completionmetricrequirements_help'] = 'Optionally require one or more advanced writing metrics for completion. For each selected metric, choose whether the entry value must be at least (>=) or at most (<=) the threshold. Completion is achieved when at least one entry meets all selected metric requirements.';
$string['completionmetricstudentmetatleast'] = 'Target met. Aim to stay at or above {$a->target}. This goal is worth {$a->penalty} {$a->pointlabel}.';
$string['completionmetricstudentmetatmost'] = 'Target met. Aim to stay at or below {$a->target}. This goal is worth {$a->penalty} {$a->pointlabel}.';
$string['completionmetricstudentneedsworkatleast'] = 'Keep working. Aim for at least {$a->target}. This goal is worth {$a->penalty} {$a->pointlabel}.';
$string['completionmetricstudentneedsworkatmost'] = 'Keep working. Aim to stay at or below {$a->target}. This goal is worth {$a->penalty} {$a->pointlabel}.';
$string['completionmetricstudentpointplural'] = 'points';
$string['completionmetricstudentpointsingular'] = 'point';
$string['completionmetricthreshold'] = 'Required value';
...
$string['coursetopiccurrentpromptmode'] = 'Prompt mode: {$a}';
$string['coursetopiccurrentpromptmodechoicecomplete'] = 'Prompt mode: Choice ({$a->required} of {$a->total} required)';
$string['coursetopiccurrentpromptmoderandomcomplete'] = 'Prompt mode: Random ({$a->required} of {$a->total} required)';
...
$string['detectallphrasespresent'] = 'Detected that all {$a->one} prompt phrase-rules are being used.';
$string['detectcommonerror'] = 'Detected at least {$a->one}, {$a->two}. They are: {$a->three}
<br>If allowed, you should fix and re-submit.';
$string['detectmissingphrase'] = 'Detected {$a->one} missing prompt phrase-rule matches. They are: {$a->two}
<br>If allowed, you should fix and re-submit.';
...
$string['duplicateprompt'] = 'Duplicate';
$string['duplicatepromptsuccess'] = 'Duplicated {$a} prompt(s).';
...
$string['enablecomments_descr'] = 'If enabled, comments can be made on individual diary entries.';
$string['enablecomments_help'] = 'If enabled, teachers and students can add comments to individual diary entries.';
$string['enablecomments_title'] = 'Enable comments';
...
$string['inlineattachmentpreviews'] = 'Show inline attachment previews';
$string['inlineattachmentpreviews_descr'] = 'Default for new Diary activities. Teachers can override this per activity in Appearance settings.';
$string['inlineattachmentpreviews_help'] = 'When enabled, Diary can show attachment previews inline below entries (for supported file types). Disable to show download links only.';
$string['inlineattachmentpreviews_title'] = 'Default inline attachment previews';
...
$string['longwordspersentence_help'] = 'Average number of long words per sentence in the entry text.';
$string['lowestgradeentry'] = 'Lowest rated entries:';
$string['mailed'] = 'Mailed';
$string['mailsubject'] = 'Diary feedback';
$string['manualpromptactive'] = 'Manual prompt override is active (Prompt ID: {$a}).';
$string['manualpromptclearsuccess'] = 'Manual prompt override cleared. Prompt assignment now follows prompt mode rules again.';
$string['manualpromptselected'] = 'Manual prompt selected';
$string['manualpromptsetfailure'] = 'Could not set manual prompt override to prompt ID {$a}.';
$string['manualpromptsetsuccess'] = 'Manual prompt override set to prompt ID {$a}.';
$string['max'] = ' max';
$string['maxc'] = ' Max: ';
...
$string['maxeditopens'] = 'Maximum edit openings per entry';
$string['maxeditopens_help'] = 'Set the maximum number of times a student can open an existing entry in the editor. 0 means unlimited.';
...
$string['promptcopyheading'] = 'Copy prompts from a Diary';
...
$string['promptcopynosources'] = 'There are no Diary activities with prompts in this course.';
...
$string['promptcopysource_help'] = 'Choose the Diary activity to copy prompts from. You can select this activity to duplicate its existing prompts. The number in brackets is how many prompts that activity currently has. Copied prompts are added to this activity; existing prompts are left alone.';
...
$string['promptimportinvaliddate'] = 'Row {$a->row} was skipped because {$a->column} contains an invalid date: {$a->value}';
...
$string['promptmode'] = 'Prompt assignment mode';
$string['promptmode_help'] = 'Choose how prompts are assigned for this Diary activity. Sequential Date/Time uses the global prompt date windows. Sequential Graded unlocks prompts in order after the previous entry has been graded. Choice x of xx lets students choose which prompts to complete from the pool, and Random x of xx assigns prompts automatically until the required count is met.';
$string['promptmodechoice'] = 'Choice';
$string['promptmodechoicecomplete'] = 'Choice x of xx';
$string['promptmodecompleteall'] = 'Complete all';
$string['promptmodeinvalid'] = 'Invalid prompt mode selected.';
$string['promptmodepickerchoice'] = 'Choose a writing prompt:';
$string['promptmodepickerchoicecomplete'] = 'Choose {$a->remaining} more prompt(s) to complete — {$a->required} required total:';
$string['promptmodepickercompleteall'] = 'Complete every writing prompt — choose where to start:';
$string['promptmodepickercompleted'] = 'Completed';
$string['promptmodepickercurrent'] = 'Current';
$string['promptmodepickerdone'] = 'All required prompts completed.';
$string['promptmodepickeritem'] = 'Prompt {$a->counter}: {$a->text}';
$string['promptmodepickerrandom'] = 'Assigned writing prompt:';
$string['promptmodepickerrandomcomplete'] = 'Assigned prompts — {$a->remaining} of {$a->required} required remaining:';
$string['promptmoderandom'] = 'Random';
$string['promptmoderandomcomplete'] = 'Random x of xx';
$string['promptmodesequential'] = 'Sequential Date/Time';
$string['promptmodesequentialgraded'] = 'Sequential Graded';
...
$string['requiredpromptcount'] = 'Required prompt completions (x)';
$string['requiredpromptcount_help'] = 'Used only in Choice x of xx and Random x of xx modes. Set how many prompts each student must complete from the prompt pool.';
$string['requiredpromptcountinvalid'] = 'Required prompt completions cannot be negative.';
$string['requiredpromptcountnonpartial'] = 'Required prompt completions must be 0 unless Prompt assignment mode is Choice x of xx or Random x of xx.';
...
$string['selectuserforreport'] = 'View single user entries';
$string['sentences'] = 'Sentences:';
$string['sentencesperparagraph'] = 'Sentences per paragraph';
$string['sentencesperparagraph_help'] = 'Average number of sentences per paragraph in the entry text.';
$string['sequentialgradedpacing'] = 'Use prompt dates as relative pacing';
$string['sequentialgradedpacing_help'] = 'When enabled, each student receives the same intervals between prompt start dates, measured from when they submit the first prompt. A later prompt still requires the previous prompt to be graded before it unlocks.';
$string['setmanualprompt'] = 'Set as activity prompt';
...
$string['totalsyllables_help'] = 'Total estimated number of syllables in the entry text.';
...
$string['uniquewords_help'] = 'Number of unique words used in the entry text.';
...
$string['wordspersentence_help'] = 'Average number of words per sentence in the entry text.';
