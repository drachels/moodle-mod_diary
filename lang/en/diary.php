...
$string['transferwemail'] = 'Transfer and send email. Default: Do not send email';
$string['transferwfb'] = 'Transfer and include feedback regarding the transfer. Default: Do not include feedback';
