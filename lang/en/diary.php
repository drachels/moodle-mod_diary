...
$string['promptmode_help'] = 'Choose how prompts are assigned for this Diary activity. Sequential preserves current behavior. Choice x of xx lets students choose which prompts to complete from the pool, and Random x of xx assigns prompts automatically until the required count is met.';
...
$string['promptmodesequential'] = 'Sequential';
