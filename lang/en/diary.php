...
$string['submissionemail_help'] = 'If enabled in settings and the teacher preference is set to, Email now, the teacher receives an immediate when when a user submits an entry';
