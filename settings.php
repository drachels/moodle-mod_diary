...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('diary/showrecentactivity', get_string('showrecentactivity', 'diary'), get_string('showrecentactivity', 'diary'), 1, array(
        '0' => get_string('no'),
        '1' => get_string('yes')
    )));

    $settings->add(new admin_setting_configselect('diary/overview', get_string('showoverview', 'diary'), get_string('showoverview', 'diary'), 1, array(
        '0' => get_string('no'),
        '1' => get_string('yes')
    )));
    
    // 20201015 Default edit all entries setting.
    $settings->add(new admin_setting_configselect('diary/editall', get_string('editall', 'diary'), get_string('editall_help', 'diary'), 1, array(
        '0' => get_string('no'),
        '1' => get_string('yes')
    )));

    // 20201119 Default edit the date of any entry setting.
    $settings->add(new admin_setting_configselect('diary/editdates', get_string('editdates', 'diary'), get_string('editdates_help', 'diary'), 1, array(
        '0' => get_string('no'),
        '1' => get_string('yes')
    )));
    ...
    // Date format setting.
    $settings->add(new admin_setting_configtext('mod_diary/dateformat', get_string('dateformat', 'diary'), get_string('configdateformat', 'diary'), 'M d, Y G:i', PARAM_TEXT, 15));
